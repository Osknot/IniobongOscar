//import { RevealOnScreen } from "../RevealOnScroll"
...
export const Home = ()=>{
    ...
    <div className="text-center z-10 px-4">
        <h1 className="text-5xl md:text-7xl font-bold mb-6 pb-2 bg-gradient-to-r from-blue-500 to-cyan-600 bg-clip-text text-transparent leading-right">Hi, I'm Iniobong Oscar
        </h1>

        <p
            className="text-gray-400 text-lg mb-8 max-w-lg mx-auto"
        >Lorem ipsum dolor sit amet, consectetur adipisicing elit. Temporibus ex repellendus eaque eveniet, architecto in magnam praesentium amet possimus numquam vel, suscipit ducimus alias. Nesciunt asperiores voluptatibus itaque et! Expedita!</p>
